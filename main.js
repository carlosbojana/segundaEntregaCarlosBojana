...
let cantidadPersonas = prompt("Ingrese la cantidad de personas a dividir el gasto")
...
for (let i = 0; i < cantidadPersonas; i++) {
    amigos[i].nombre = prompt("Ingrese su nombre o el de la otra persona");
}

for (let i = 0; i < cantidadPersonas; i++) {
    amigos[i].monto = Number(prompt("Ingresa los montos de cada persona"));
}
